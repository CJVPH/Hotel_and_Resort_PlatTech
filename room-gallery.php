...
<body>
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-menu">
                <a href="room-gallery.php?type=regular" class="nav-link <?php echo $activeType==='Regular'?'active':''; ?>">Regular</a>
                <a href="room-gallery.php?type=deluxe"  class="nav-link <?php echo $activeType==='Deluxe' ?'active':''; ?>">Deluxe</a>
                <a href="room-gallery.php?type=vip"     class="nav-link <?php echo $activeType==='VIP'    ?'active':''; ?>">VIP</a>
                <?php if (isLoggedIn()): ?>
